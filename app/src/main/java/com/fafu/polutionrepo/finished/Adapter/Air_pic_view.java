...
public class Air_pic_view extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mMeasureHeigtht = getMeasureHeigtht(heightMeasureSpec);
        setMeasuredDimension(mMeasureWidth, mMeasureHeigtht);
        initView();
    }
    ...
    public void initView(){
        float length;
        if(mMeasureWidth >= mMeasureHeigtht){
            length = mMeasureHeigtht;
        }else{
